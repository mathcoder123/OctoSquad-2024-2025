...
public class Constants {
    ...
    /* -------------------------------------------- SERVO CONSTANTS -------------------------------------------- */
    //TODO TUNE
    public static double clawClose = 0.66;
    public static double clawOpen = 0.5;

    public static double backClawClose = 0.66;
    public static double backClawOpen = 0.5;
    ...
    public static int horizontalSlideLow = 100;
    public static int horizontalSlideHigh = 200;
    ...
    public static int hangRightLow = 100;
    public static int hangRightHigh = 200;
